...
require_once("dompdf/dompdf_config.inc.php");
	...
	$tabl = "<table id='showposts_table'>";
	$i=0;
	foreach($posts as $post){
		$tabl.= "<tr><td>".($i+1)."</td><td>".$post['post_title']."</td><td><a href=".plugins_url()."/post_to_pdf/getpdf.php?p=\"".urlencode($post['post_content'])."\"  >Download</a></td></tr>";
	    $i++;
	}
		$tabl.= "</table><br>";
echo $tabl;
